...
import {
   DeepPartial, FieldValues, FormProvider, SubmitErrorHandler, SubmitHandler, useForm, UseFormProps, UseFormReturn, WatchObserver,
   ...
   return (
      <>
         <FormProvider {...methods}>
            <FormSchemaContext.Provider value={{ schema, shape: schema.shape }}>
               <form
                  ref={formRef}
...
const FormSchemaContext = createContext<{ shape: z.ZodRawShape, schema: z.ZodObject<z.ZodRawShape> } | undefined>(undefined)

export const useFormSchema = (): { shape: z.ZodRawShape, schema: z.ZodObject<z.ZodRawShape> } => {
   return useContext(FormSchemaContext)! // /!\ We hope that it is always defined
}
