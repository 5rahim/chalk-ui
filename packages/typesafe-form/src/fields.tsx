...
// import { Dropzone, DropzoneHandler, DropzoneProps } from '@rahimstack/ui'
// import { ImageGridInput, ImageGridInputProps } from '@rahimstack/ui'
import {
   AddressInput, AddressInputProps, BasicFieldOptions, Checkbox, CheckboxGroup, CheckboxGroupProps, CheckboxProps, Combobox, ComboboxProps,
   currencies, DatePicker, DatePickerProps, DateRangePicker, DateRangePickerProps, MultiSelect, MultiSelectProps, NumberInput, NumberInputProps,
   PhoneNumberInput, PhoneNumberInputProps, PriceInput, PriceInputProps, RadioGroup, RadioGroupProps, Select, SelectProps, Switch, SwitchProps,
   Textarea, TextareaProps, TextInput, TextInputProps, TimeInput, TimeInputProps, useUILocaleConfig,
} from '@rahimstack/ui'
...
// const ColorAreaField = React.memo(withControlledInput(forwardRef<HTMLDivElement,
//    FieldComponent<ColorAreaPickerProps>>((props, ref) => {
...
/**
 * @description The main image is always required
 * @description The name of the field is automatically set to "images"
 * @example
 ...
 * @constructor
 */
// const ImageGridField = React.memo(withControlledInput(forwardRef<HTMLDivElement, FieldComponent<ImageGridInputProps>>(
//    (props, ref) => {
//
//       const context = useFormContext()
//
//       return <ImageGridInput
//          defaultImages={get(context.formState.defaultValues, props.name)} // Can be overridden
//          {...props}
//       />
//    },
// )))
...
const ComboboxField = React.memo(withControlledInput(forwardRef<HTMLInputElement, FieldComponent<ComboboxProps>>(
   (props, ref) => {
      const context = useFormContext()
      // /!\ Cannot be controlled using `value` prop yet
      return <Combobox
         {...props}
         defaultValue={get(context.formState.defaultValues, props.name)} // Cannot be overridden
         ref={ref}
 ...
 * <Field.Switch />
 */
const SwitchField = React.memo(withControlledInput(forwardRef<HTMLInputElement, FieldComponent<SwitchProps>>(
   (props, ref) => {
      const context = useFormContext()
      return <Switch
         {...props}
 ...
 * <Field.Checkbox />
 */
const CheckboxField = React.memo(withControlledInput(forwardRef<HTMLInputElement, FieldComponent<CheckboxProps>>(
   (props, ref) => {
      const context = useFormContext()
      return <Checkbox
         {...props}
...
const CheckboxGroupField = React.memo(withControlledInput(forwardRef<HTMLDivElement, FieldComponent<CheckboxGroupProps>>(
   (props, ref) => {
      ...
      return <CheckboxGroup
         {...props}
         defaultValues={get(context.formState.defaultValues, props.name) ?? []} // Cannot be overridden
         ref={ref}
      />
   },
)))
...
// type DropzoneFieldProps = Omit<DropzoneProps, "onChange"> & { handler: DropzoneHandler }
/**
 ...
 * />
 */
// const DropzoneField = React.memo(withControlledInput(forwardRef<HTMLInputElement, FieldComponent<DropzoneFieldProps>>(
//    (props, ref) => {
//
//       const [{ handler }, basicFieldProps] = extractBasicFieldProps<DropzoneFieldProps>(props, useId())
//       const controller = useController({ name: basicFieldProps.name! })
//
//       return <BasicField {...basicFieldProps}>
//          <Dropzone
//             maxSize={5242880} // Can be overridden
//             {...props}
//             accept={handler.accept} // Cannot be overridden
//             multiple={handler.multiple} // Cannot be overridden
