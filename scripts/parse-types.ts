...
// // const input = `type DonutChartProps = React.HTMLAttributes<HTMLDivElement> & { data: any[] category?: string index?: string colors?: UIColor[] variant?: "donut" | "pie" valueFormatter?: ChartValueFormatter label?: string showLabel?: boolean showAnimation?: boolean showTooltip?: boolean noDataText?: string } type DonutChartTooltipProps = { active?: boolean payload: any valueFormatter: ChartValueFormatter }`
// parseTypes(input)
//
