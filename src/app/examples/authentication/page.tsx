...
export default function Page() {
    ...
    return (
        <AppLayoutGrid cols={6} breakBelow="lg">
            <AppLayoutStack className="col-span-3 h-dvh flex items-center">
            ...
            <div
                className="hidden lg:block h-dvh col-span-3 bg-gray-50 dark:bg-gray-200 bg-blend-multiply dark:bg-blend-difference bg-[url(/images/swirl.png)] relative"
            >
                <div className="w-[100%] h-[600px] absolute -bottom-10 -right-16 rounded-xl overflow-hidden dark:shadow-none shadow-xl transition-shadow hover:shadow-md z-[1] bg-[url(/images/so-dashboard-light.png)] dark:bg-[url(/images/so-dashboard-dark.png)]">
