...
- ⚠️ Make sure you take note of components with breaking changes. [CHANGELOG.md](https://github.com/5rahim/chalk-ui/blob/main/CHANGELOG.md).
...
- ⚠️ The **tailwind.config.js** and **globals.scss** files will stay the same
