                ...
                <div className="mt-10 space-y-4 relative">
                    ...
                    <div>
                        <RadioGroup
                            ...
                            stackClassName="flex flex-row gap-2 p-1 bg-gray-50 rounded-[--radius] border w-fit space-y-0"
                            radioContainerClassName="block w-fit py-1 px-3 cursor-pointer border border-transparent transition rounded-[--radius] data-checked:bg-white data-checked:border-gray-300 data-checked:shadow-sm text-gray-500 data-checked:text-black"
