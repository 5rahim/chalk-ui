...
export const CheckboxAnatomy = defineStyleAnatomy({
    ...
    control: cva([
        ...
        "outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50",
        ...
        variants: {
            ...
            hasError: {
                true: "border-red-500 dark:border-red-500 data-[state=checked]:border-red-500 dark:data-[state=checked]:border-red-500",
                false: null,
            },
        },
        defaultVariants: {
