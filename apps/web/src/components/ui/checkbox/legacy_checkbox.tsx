...
export const CheckboxAnatomy = defineStyleAnatomy({
    control: cva([
        ...
        "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 data-checked:bg-brand-500 dark:data-checked:bg-brand-500",
        "data-checked:border-brand-500 dark:data-checked:border-brand-500 data-disabled:bg-gray-100 dark:data-disabled:bg-gray-800 data-disabled:border-gray-100 dark:data-disabled:border-gray-800",
        "data-disabled:hover:bg-gray-100 dark:data-disabled:hover:bg-gray-800",
    ], {
        variants: {
            size: {
                md: "h-5 w-5 text-xs",
...
export const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>((props, ref) => {
    ...
    const [{
        ...
        rootLabelClassName,
        iconClassName,
    }, { error, label, ...basicFieldProps }] = extractBasicFieldProps<CheckboxProps>(props, useId())
