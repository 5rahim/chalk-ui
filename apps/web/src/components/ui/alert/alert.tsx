   ...
   container: cva("UI-Alert__container py-3 px-4 flex justify-between rounded-md", {
      variants: {
         intent: {
            ...
            "info-basic": "bg-white text-gray-800 border __UI__DARK__ border-[--border] dark:bg-gray-800 dark:text-gray-200",
            "success-basic": "bg-white text-gray-800 border __UI__DARK__ border-[--border] dark:bg-gray-800 dark:text-gray-200",
            "warning-basic": "bg-white text-gray-800 border __UI__DARK__ border-[--border] dark:bg-gray-800 dark:text-gray-200",
            "alert-basic": "bg-white text-gray-800 border __UI__DARK__ border-[--border] dark:bg-gray-800 dark:text-gray-200",
         },
      },
      defaultVariants: {
         intent: "info",
