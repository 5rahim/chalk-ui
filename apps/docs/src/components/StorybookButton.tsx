...
const StorybookButton: React.FC<StorybookButtonProps> = (props) => {
    ...
    return (
      <a href={"https://chalk-storybook.rahim.app/?path=/docs/" + slug} target="_blank">
         <span
             className="px-4 py-2 rounded-[--radius] border dark:border-gray-700 inline-flex gap-2 items-center font-medium mt-4 transition ring-red-500 hover:ring-1 dark:hover:border-gray-600">
