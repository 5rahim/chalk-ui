...
- Some components such as Button, Badge and Alert have a `intent` property, which features different colors in their styling such as `primary` with features the brand color.
