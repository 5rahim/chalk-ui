try {
    var a = "storybook/outline", u = "outline";
    var n = __REACT__, {
        Children: L,
        Component: x,
        Fragment: M,
    ...
    var A = m(function () {
        let [r, y] = d(), c = O(), l = [!0, "true"].includes(r[u]), s = p(() => y({[u]: !l}), [l]);
        return S(() => {
            c.setAddonShortcut(a, {label: "Toggle Outline [O]", defaultShortcut: ["O"], actionName: "outline", showInMenu: !1, action: s})
        }, [s, c]), n.createElement(T, {
            key: "outline",
            active: l,
